...
drawFixation(visual.fixCkCol,fixPos(1:2),scr,visual);
Screen('Flip', scr.main);

Eyelink('command','draw_box %d %d %d %d 15', round(cxm-2*visual.ppd), round(cym-2*visual.ppd), round(cxm+2*visual.ppd), round(cym+2*visual.ppd));
